...
This reference shows how to use APIs to sort results in a database.
...
```
<p class = "p_frase">Default value is in ascending mode, you can use with 'asc' or 'desc' as you want</p>
